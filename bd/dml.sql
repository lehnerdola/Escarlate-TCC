...
alter table tb_categoria_musical 
      ...
      references tb_artista(id_artista);use Escarlate;
...
insert into tb_artista (nm_artista, ds_artista, img_artista)
        values('METALICAAA', 'Metallica é uma banda norte-americana de heavy metal. O seu repertório inclui instrumentos e musicalidade agressiva. O Metallica formou-se em 1981.', 'https://www.metalremains.com/images/grupo.jpg');        
...
-- cadastrar novo prod
insert into tb_produto(id_artista, id_categoria, nm_produto, ds_tam, bt_disponivel, vl_preco, qtd_produto, img_produto) 
        values ( 2, 1, 'Metallica poster Master of Puppets', '20cm x 29,7cm', true, '0,00', 1, 'https://www.europosters.pt/posters/metallica-master-of-puppets-v20848');
